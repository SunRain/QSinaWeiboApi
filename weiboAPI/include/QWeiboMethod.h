...
//        WBOPT_GET_STATUSES_HOT_COMMENTS_WEEKLY,//按周返回热门评论榜
        ...
        WBOPT_GET_FRIENDSHIPS_IN_COMMON,//获取共同关注人列表接口表
        WBOPT_GET_FRIENDSHIPS_FRIENDS_BILATERAL,///获取双向关注列表
        ...
        WBOPT_GET_FRIENDSHIPS_FOLLOWERS,///获取用户粉丝列表及每个粉丝的最新一条微博
        WBOPT_GET_FRIENDSHIPS_FOLLOWERS_IDS,//获取用户粉丝对象uid列表
        WBOPT_GET_FRIENDSHIPS_FOLLOWERS_ACTIVE,//获取用户优质粉丝列表关系链
        WBOPT_GET_FRIENDSHIPS_CHAIN_FOLLOWERS,//获取我的关注人中关注了指定用户的分组
        WBOPT_GET_FRIENDSHIPS_SHOW,//获取两个用户关系的详细情况
        WBOPT_GET_FRIENDSHIPS_GROUPS, //获取当前登陆用户好友分组列表
        ...
        WBOPT_POST_FRIENDSHIPS_GROUPS_DESTROY,//删除好友分组
